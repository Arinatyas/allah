...
# Install Streamlit and ngrok in Colab
...
with open("app.py", "w") as f:
    ...
    def predict(age, gender, total_bilirubin, direct_bilirubin, alkaline_phosphotase,
    ...
    alkaline_phosphotase = st.number_input("Alkaline Phosphotase", min_value=0.0, step=0.1)
    alamine_aminotransferase = st.number_input("Alamine Aminotransferase", min_value=0.0, step=0.1)
    aspartate_aminotransferase = st.number_input("Aspartate Aminotransferase", min_value=0.0, step=0.1)
    total_protiens = st.number_input("Total Proteins", min_value=0.0, step=0.1)
    ...
    if st.button("Predict"):
        result = predict(age, gender, total_bilirubin, direct_bilirubin, alkaline_phosphotase,
                         alamine_aminotransferase, aspartate_aminotransferase, total_protiens,
                         albumin, albumin_and_globulin_ratio)
...
# Connect to ngrok with the correct port (8501 for Streamlit)
public_url = ngrok.connect("8501")  # Specify the port here
