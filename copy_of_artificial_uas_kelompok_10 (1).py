...
direct_bilirubin = st.number_input("Direct Bilirubin", min_value=0.0, value=1.0)
alkaline_phosphotase = st.number_input("Alkaline Phosphotase", min_value=0.0, value=1.0)
alamine_aminotransferase = st.number_input("Alamine Aminotransferase", min_value=0.0, value=1.0)
aspartate_aminotransferase = st.number_input("Aspartate Aminotransferase", min_value=0.0, value=1.0)
total_protiens = st.number_input("Total Proteins", min_value=0.0, value=1.0)
